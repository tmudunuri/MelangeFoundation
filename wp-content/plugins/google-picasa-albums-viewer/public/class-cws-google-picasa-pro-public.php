 ...
 * @subpackage CWS_Google_Picasa_Pro/public
 */
 ...
 */
class CWS_Google_Picasa_Pro_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/cws-google-picasa-pro-public.css', array(), $this->version, 'all' );

		// TODO: make the inclusion of this conditional?
		// can I move this to results_grid.php
		wp_enqueue_style( 'lightbox', plugin_dir_url( __FILE__ ) . 'css/lightbox/lightbox.css', array(), $this->version, 'all' );
		
		// removed these ready for v3
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/cws-google-picasa-pro-public.js', array( 'jquery' ), $this->version, false );
